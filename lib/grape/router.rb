...
module Grape
  class Router
    ...
    def suppress_synthesized_head_for(pattern_regexp)
      @head_suppressed_patterns << pattern_regexp
    end

    def synthesized_head_suppressed?(pattern_regexp)
      @head_suppressed_patterns.include?(pattern_regexp)
    end
